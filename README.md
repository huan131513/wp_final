...
## 每組員負責項目
- 彭子桓：地圖系統、導航、UI、廁所資訊介面、打卡紀錄、評論區、登入註冊、回報/新增地點系統、優化資料庫、管理者dashboard (不僅上述提及之項目，還有很多細節)
- 許元瑞：會員中心、成就系統、小遊戲、活躍度排行榜、廁所資料爬蟲、管理者dashboard、回報系統、通知系統、密碼強度驗證  (不僅上述提及之項目，還有很多細節)
